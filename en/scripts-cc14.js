...
//#                                                                            #
//##############################################################################
//all-in-on title token search tool BKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBKBK
$("#BKgetAssetInfoAll").submit(function(event){
  event.preventDefault();
  ...
  $.ajax({
    ...
    success:function(response){
      ...
      if (getAssetObj.errorDescription =="Unknown asset"){
        ...
        $("#advisoryUn").removeClass("d-none");
        $("#testTable").hide();
      }else{
        $("#modalBlockContainer").removeClass("d-none");
        ...
        if (getAssetObj.quantityQNT==0) {
          $("#test-q4-result").html("<strong style='color:red'>NO!</strong>");
          $("#advisoryA4").removeClass("d-none");
          $("#blockTokenRedeem").addClass("d-none");
        }else{
          $("#test-q4-result").html("<strong style='color:green'>YES</strong>");
        };
      ...
      if (getAssetObj.errorDescription =="Unknown asset"){
        ...
        if(getAssetObj.initialQuantityQNT ==1 &&  getAssetObj.decimals == 0){
          ...
          if(getAssetObj.quantityQNT == 1){
            ...
            $("#titleSearch-Q3-result").html('<strong style="color:green">YES</strong>');
          }else{
            $("#advisoryA3").removeClass("d-none");
            $("#titleSearch-Q3-result").html('<strong style="color:red">NO!</strong>');
      ...
      if (i>=1){
        for(k=0; k<i; k++){
          ...
          if (m > 0){
            ...
            var setter = "Unknow wallet, anonumous asset property setter.";
            var jobFunction = "Unclassified, <a href='utilities.html'>contact setter</a>";
          };
          var index = k+1;
          var displayTbl='<table class="table word-break table-bordered table-sm fs-6 table-bordered caption-top">'+
                    ...
                    '<tr><td class="td-1">Setter wallet</td><td class="td-2">' + setterRS +'</td></tr>'+
                    '<tr><td class="td-1">Job function</td><td class="td-2">' + jobFunction +'</td></tr>'+
                    '<tr><td class="td-1">Property</td><td class="td-2">' + property + ' : ' + value +'</td></tr></table>';
    ...
    success:function(response){
      ...
      if (m>= 0){
        ...
        if(issuanceEpoch <walletExpEpoch){
          $("#titleSearch-Q2-result").html("<strong style='color:green'>YES</strong>");
        }else{
          $("#titleSearch-Q2-result").html("<strong style='color:red'>NO!</strong>");
        ...
        $("#validateWalletInfoFormCode").html(JSON.stringify(myAddressBookObj[m]));
        ...
        $("#titleSearch-Q1-result").html("<strong style='color:green'>YES</strong>");

      }else{
        $("#titleSearch-Q1-result").html("<strong style='color:red'>NO!</strong>");
        $("#titleSearch-Q2-result").html("<strong style='color:#d9d9d9'>N/A</strong>");
    ...
    success:function(response){
      ...
      for (k=0; k<numberOfAccounts; k++){
        ...
        if (m > 0){
          var entityName  = myAddressBookObj[m].walletInfo.entityName;
          var jobFunction = myAddressBookObj[m].walletInfo.walletAssignment;
          // if(numberOfAccounts==1 && jobFunction !="activation"){
          //   $("#blockTokenRedeem").addClass("d-none");
          //   $("#blockTokenTransfer").removeClass("d-none");
          // };
        }else{
          var entityName  = "Unknow wallet. You may ask seller to proof ownership of this wallet by using <a href='evidence.html'>Generate message token</a> for an arbitrary message. If wallet validation is not an option, please move on to another item.";
          var jobFunction = "Unclassified, <a href='utilities.html'>contact wallet owner</a>";
          // $("#test-q7-yes").html("");
          // $("#test-q7-no").html("&#x2716;");
        };
        var index       = k+1;
        displayTbl='<table class="table word-break table-bordered table-sm fs-6 table-bordered caption-top">'+
                  ...
                  '<tr><td class="td-1">Entity</td><td class="td-2">' + entityName +'</td></tr>'+
                  '<tr><td class="td-1">accountRS</td><td class="td-2">' + accountRS +'</td></tr>'+
                  '<tr><td class="td-1">Responsibility</td><td class="td-2">' + jobFunction +'</td></tr>'+
  ...
  $.ajax({
    ...
    success:function(response){
      ...
      for(var i=0; i<length; i++){
        ...
        if (m < 0){
          var senderName       = "Unknow wallet, anonumous sender.)";
          var senderAssignment = "Unclassified, <a href='utilities.html'>contact sender</a>";
        }else{
        ...
        if (n < 0){
          var recipientName       = "Unknow wallet, anonumous recipient.";
          var recipientAssignment = "Unclassified, <a href='utilities.html'>contact recipient</a>";
          answersQ7++;
        }else{
        ...
        var index = length-i;
        displayTbl='<h5>Transaction #' + index +' of '+length+' </h5>'+
                   ...
                   '<table class="table word-break table-bordered table-sm fs-6 table-bordered caption-top">'+
                     ...
                     '<tr><td class="td-3">job function</td><td class="td-2">' + senderAssignment +'</td></tr>'+
                   '</table>'+
                   '<table class="table word-break table-bordered table-sm fs-6 table-bordered caption-top">'+
                     ...
                     '<tr><td class="td-3">job Function</td><td class="td-2">' + recipientAssignment +'</td></tr>'+
                   '</table>';
        $("#assetIssuerTbl").before(displayTbl);
      };
      if(answersQ4 > 0){
        $("#titleSearch-Q4-result").html("<strong style='color:green'>YES</strong>");
        $("#assetInforTbl-activateDate").html(localTime[0] +" " + localTime[1] + ", "+localTime[2]+" days");
      }else{
        $("#titleSearch-Q4-result").html("<strong style='color:red'>NO!</strong>");
        $("#advisoryA4").removeClass("d-none");
        $("#modalBlockContainer").addClass("d-none");
      };
      if(answersQ5 > 0){
        $("#titleSearch-Q5-result").html("<strong style='color: red'>NO!</strong>");
        $("#advisoryA5").removeClass("d-none");
        $("#modalBlockContainer").addClass("d-none");
      }else{
        $("#titleSearch-Q5-result").html("<strong style='color: green'>YES</strong>");
      };
      if(answersQ6 > 0){
        $("#titleSearch-Q6-result").html("<strong style='background-color:yellow'>YES</strong>");
        $("#advisoryA6").removeClass("d-none");
      }else{
        $("#titleSearch-Q6-result").html("<strong style='color:green'>NO</strong>");
      };
      if(answersQ7 > 0){
        $("#titleSearch-Q7-result").html("<strong style='background-color:yellow'>YES</strong>");
        $("#advisoryA7").removeClass("d-none");
      }else{
        $("#titleSearch-Q7-result").html("<strong style='color:green'>NO</strong>");
      };
...
$("#validateTitlTokenForm").submit(function(event){
  ...
  $.ajax({
    ...
    success:function(response){
      var responseObj  = JSON.parse(response);
      console.log(responseObj.validateTitleToken);
      if (responseObj.validateTitleToken == "failed"){
        var message = "<b style='color:red'>Decryption failed! Beware of counterfeiting. </b><br>Verification code was not generated by <code>YOUR_COMPANY_NAME_HERE</code>.";
        alert("Decryption failed!");
      }else if (responseObj.validateTitleToken == "mismatch"){
        var message= "<b style='color:red'>Mismatching! Beware of counterfeiting. </b><br>Secure code scaned: "+formData[0].value+" <br>Decrypted verificationcode: "+responseObj.decrypted;
        alert("Mismatching!");
      }else{
        var message= "<b style='color:green'>Valid verification code</b><br>Secure code scaned: "+formData[0].value+"<br>Decrypted verificationcode: "+responseObj.decrypted;
      };
      console.log(message);
...
$("#pin2newWalletForm").submit(function(event){
  ...
  $.ajax({
    ...
    success:function(response){
      ...
      $("#requestTitlTokeneResponse").removeClass("d-none");
      var newWalletDisp = "Address: " + accountRSLS + "<br>PublicKey: " + pubKeyLS + "<br>Passphrase: " + newSecret;
  ...
  $.ajax({
    ...
    success:function(response){
      ...
      if (responseObj.requestTitleToken == "failed"){
        var message = "<b style='color:red'>Decryption failed! Beware of counterfeiting. </b><br>Verification code was not generated by <code>demo account</code>. ";
        ...
        var requestDTResult = "<b style='color:green'>Request granted!</b><br> Title token, ID "+asset+
                              " , transfered to wallet address: "+recipientRS+
      ...
      $.ajax({
        ...
        success:function(response){
          ...
          if(responseObj.errorDescription=='Incorrect "recipient"'){
            $("#transferAssetResult").html("Incorrect recipient wallet address, please verify.")
          }else if(responseObj.errorDescription=="Unknown account"){
            $("#transferAssetResult").html("Unknown account, please verify passphrase and retry.")
          }else{
            var senderRS         = responseObj.transactionJSON.senderRS;
            var recipientRS      = responseObj.transactionJSON.recipientRS;
...
// broadcastTransactionFnx =====================================================
function broadcastTransactionFnx(selector){
  event.preventDefault();
  ...
  for(i=0; i<issueQty;i++){
    ...
    $.ajax({
      ...
      success:function(response){
        var responseObj = JSON.parse(response);
        // transactionBytesArray[i] = responseObj.transactionBytes;
        // console.log(transactionBytesArray[i]);
        var fullHash    = responseObj.fullHash;
        var assetID     = NRS.fullHashToId(fullHash);
        var feeCC14     = responseObj.transactionJSON.feeNQT/100000000;
        var timestamp   = responseObj.transactionJSON.timestamp;
